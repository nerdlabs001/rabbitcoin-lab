...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. RabbitCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "rabbitcoin:"))
        {
            ...
            try {
                ...
                if (mq.try_send(strURI, strlen(strURI), 0))
                    ...
                    // if URI could not be sent to the message queue do a normal RabbitCoin-Qt startup
                    break;
            }
